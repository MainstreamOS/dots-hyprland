...
--##! Apps (fork f9dec549: W→wallpaper, B→browser)
...
hl.bind("CTRL + SUPER + Backslash", hl.dsp.window.resize({x = 640, y = 480}), {description = "Resize active to 640x480"} )
