...
ApplicationWindow {
    ...
    // drawn with fill:currentColor, so the mask recolors them cleanly.
    component TrayAppIcon : AppIcon {
        property string trayIcon
        source: "/usr/share/icons/Papirus/24x24/panel/" + trayIcon
        implicitSize: 11
        isMask: true
...
readonly property var drawerApps: root.drawerApps
    ...
    component Card1BarTour : Item {
        ...
        // Centre-x of each pointer target. The three pills that move with the
        // bar layout are measured off the pills themselves, so the pointer
...
readonly property var drawerApps: root.drawerApps
    ...
    component Card5FileDragViaBar : Item {
        ...
        readonly property int barPillLeftMargin: 10
        // The workspace pill is against the left edge, so the slots the drag
        // aims at are measured from there. Shared with the pill's own anchor
        // below so the two cannot drift apart.
        readonly property int barPillX: barX + barPillLeftMargin
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            ...
                            // The tray sits past the workspaces, the way the
                            // other panels draw it.
                            Rectangle {
                                id: sysTray11
                                anchors.left: workspacePill11.right
                                anchors.leftMargin: 3
                                anchors.verticalCenter: parent.verticalCenter
                            ...
                            // Now playing, in the right-hand group where the
                            // shipped layout puts it.
                            Rectangle {
                                id: mediaPill11
                            ...
                            Rectangle {
                                id: workspacePill11
                                anchors.left: parent.left
                                anchors.leftMargin: card5.barPillLeftMargin
                                anchors.verticalCenter: parent.verticalCenter
                                height: card5.barPillH
                            ...
                            // The status icons against the right edge, past
                            // what is playing, the way the bar orders them.
                            Rectangle {
                                id: sysTrayPill11
                                anchors.right: parent.right
                                anchors.verticalCenter: parent.verticalCenter
