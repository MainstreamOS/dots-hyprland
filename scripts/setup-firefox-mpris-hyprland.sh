#!/usr/bin/env bash
# Build + install firefox-mpris-hyprland as a pacman package.
#
...
#   - the Rust native host          -> /usr/bin/firefox-mpris-host
#   - the system native-messaging manifest (covers Firefox + forks incl. Zen)
#   - the WebExtension .xpi          -> /usr/share/firefox-mpris-hyprland/
...
printf "${C_G}[firefox-mpris]${C_RST} installed.\n"
