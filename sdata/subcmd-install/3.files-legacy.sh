...
case "${SKIP_HYPRLAND}" in
  ...
  *)
    ...
    # hyprlock.conf + monitors.lua use __auto_backup: monitors.lua is
    # auto-generated by Quickshell Settings → Display once the user
    # customises per-monitor settings, so a re-install must not clobber
    # their saved layout. hyprlock.conf is similarly user-tweakable.
    for i in hyprlock.conf monitors.lua ; do
